...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p d149f8f3-4e9a-4746-b8a2-ec62b4b79872
```

> `d149f8f3-4e9a-4746-b8a2-ec62b4b79872` is the password of the certificate, you can change it to any password you want.
